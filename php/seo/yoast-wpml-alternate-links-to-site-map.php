 ...
 */
function kapow_core_yoast_wpml_alternate_links_to_site_map_setup( $url, $type, $post ) {
...
add_filter( 'wpseo_sitemap_entry', 'kapow_core_yoast_wpml_alternate_links_to_site_map_setup', 100, 3 );
 ...
 */
function kapow_core_yoast_wpml_alternate_links_to_site_map( $output, $url ) {
...
add_filter( 'wpseo_sitemap_url', 'kapow_core_yoast_wpml_alternate_links_to_site_map', 100, 2 );
