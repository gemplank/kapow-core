 ...
 * constant.
 */
function kapow_core_change_wp_engine_name() {
...
add_action( 'admin_menu', 'kapow_core_change_wp_engine_name', 9999 );
 ...
 */
function kapow_core_override_robots_txt_save() {
...
add_filter( 'pre_option_blog_public', 'kapow_core_override_robots_txt_save' );
