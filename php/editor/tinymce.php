 ...
 */
function kapow_core_tiny_mce_block_formats( $settings ) {
...
add_filter( 'tiny_mce_before_init', 'kapow_core_tiny_mce_block_formats' );
 ...
 */
function kapow_core_tiny_mce_editor_buttons( $buttons ) {
...
add_filter( 'mce_buttons_2', 'kapow_core_tiny_mce_editor_buttons' );
