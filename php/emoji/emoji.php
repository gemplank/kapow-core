 ...
 *  Disable WP Emoji
 */
function kapow_core_disable_emoji() {
	...
	add_filter( 'tiny_mce_plugins', 'kapow_core_disable_emoji_tinymce' );
}
add_action( 'init', 'kapow_core_disable_emoji' );
 ...
 */
function kapow_core_disable_emoji_tinymce( $plugins ) {
